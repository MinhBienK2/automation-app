...
export const behaviorScenarios: BehaviorScenario[] = [
  ...
  },
  {
    ...
    actions_and_fields: [
      ...
      "scroll.mode=until_element_visible",
      "scroll.style=human_like",
      "scroll.style=smooth_single",
    ],
...
export const behaviorFieldVariants: BehaviorFieldVariant[] = [
  ...
  fieldVariant("scroll.mode", ["page", "into_view", "until_element_visible"], ["pointer_page_interaction"], [...pointerActions, ...runnerTests]),
  fieldVariant("scroll.style", ["human_like", "smooth_single"], ["pointer_page_interaction"], runnerTests),
