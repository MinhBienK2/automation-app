...
- Click config editing keeps direct locator targeting and Find Element ref targeting as exclusive UI modes. The ref mode hides locator fields while preserving saved locator config so users can switch back without rebuilding it.
