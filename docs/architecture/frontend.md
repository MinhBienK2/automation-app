...
- Workflow Settings editing through list Edit and detail Settings, Browser device profile presets that coherently fill user agent, viewport, mobile, and touch settings, section save state, bilingual section help with field-level guidance, and run-before-save orchestration.
