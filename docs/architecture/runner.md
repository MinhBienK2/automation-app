...
- Browser context: Set Viewport changes runtime width and height only; Browser Launch does not expose viewport width, viewport height, device scale factor, mobile mode, or touch capability controls.
