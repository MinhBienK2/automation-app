...
- Capture Data: text/attribute/field/table/list extraction, regex extraction from prior outputs, screenshots, text-file artifacts, and downloads that create outputs.
