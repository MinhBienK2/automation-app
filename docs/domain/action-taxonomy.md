...
- Browser Context: dialogs, downloads, runtime viewport size, geolocation, permissions, and other runtime-safe browser context actions. Device scale factor, mobile mode, and touch capability are launch-time Custom fingerprint overrides, not in-run Set Viewport behavior.
