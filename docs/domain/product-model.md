...
- A compiled workflow graph is a generated executable plan that maps supported graph nodes to action configs.
- The visual graph editor is the primary UI for graph logic. It can add/connect/delete nodes, edit supported logic configs, validate graph issues, run supported graphs, and show run timeline/output context.
