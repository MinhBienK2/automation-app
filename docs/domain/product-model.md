...
- Workflow Settings is the per-workflow configuration aggregate for workflow identity, execution defaults, browser launch profile, environment defaults, initial variables, triggers, and advanced compatibility diagnostics.
