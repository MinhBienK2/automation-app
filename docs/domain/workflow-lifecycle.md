...
- Workflow Settings Graph Defaults owns the default duration-only wait copied onto newly created graph links. Changing it does not rewrite existing graph links.
