...
- **Verify**: `src/App.tsx`, `src/features/workflows/`, `src/lib/workflowApi.ts`, `src/lib/workflowUi.ts`
...
- **Verify**: `src/features/projects/`, `src/features/workflows/pages/SubflowListPage.tsx`, `src/features/workflows/pages/SubflowDetailPage.tsx`, `electron/backend/commands.ts`, `electron/backend/persistence/`, `electron/backend/services/`, `electron/backend/projects/`
...
- **Verify**: `src/lib/workflowApi.ts`, `src/types/electron.ts`, `electron/preload.cts`, `electron/ipc.ts`, `electron/main.ts`, focused `electron/backend/` modules
...
- **Verify**: `electron/backend/recording/`, `electron/backend/commands.ts`, `src/lib/workflowApi.ts`, `src/types/workflow.ts`, recorder UI under `src/features/workflows/`
...
- **Verify**: `electron/backend/graph/validateGraph.ts`, `electron/backend/graph/compiler.ts`, `electron/backend/actions/validation.ts`, `electron/backend/commands.ts`
...
- **Verify**: `electron/backend/persistence/`, `electron/backend/commands.ts`, `electron/backend/services/`
...
- **Verify**: `src/features/schedules/`, `electron/backend/scheduling/`, `electron/backend/commands.ts`, `electron/backend/runtime/runManager.ts`
...
- **Verify**: `src/features/overview/`, `electron/backend/operations/`, `electron/backend/commands.ts`
...
- **Verify**: `src/App.tsx`, `src/layouts/`, `src/features/*/`
- **Checks**: `npm test -- src/App.test.tsx src/layouts/AppShell.test.tsx`, `npx tsc --noEmit`
...
- **Verify**: `src/features/identities/`, `electron/backend/identity/`, `electron/backend/commands.ts`
- **Checks**: `npm test -- electron/backend/commands.test.ts src/lib/workflowApi.test.ts`, `npx tsc --noEmit`
