export const workflowIpcChannels = {
  ...
  listDesktopTargets: "workflow:listDesktopTargets",
  createDesktopTarget: "workflow:createDesktopTarget",
  ...
  getAppSettings: "workflow:getAppSettings",
  saveAppSettings: "workflow:saveAppSettings",
} as const;
