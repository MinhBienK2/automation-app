...
import { createBooleanVariablesExecutors } from "./boolean.js";
import { createCoreVariablesExecutors } from "./core.js";
import { createListVariablesExecutors } from "./list.js";
import { createNumberVariablesExecutors } from "./number.js";
import { createObjectVariablesExecutors } from "./object.js";
import { createTextVariablesExecutors } from "./text.js";

export type VariablesExecutors = Pick<
  ActionExecutorMap,
...
export function createVariablesExecutors<Runtime extends RunnerActionRuntime>(
  runtime: Runtime,
  deps: RunnerActionExecutorDependencies<Runtime>,
): VariablesExecutors {
  return {
    ...createCoreVariablesExecutors(runtime, deps),
    ...createNumberVariablesExecutors(runtime, deps),
    ...createTextVariablesExecutors(runtime, deps),
    ...createBooleanVariablesExecutors(runtime, deps),
    ...createListVariablesExecutors(runtime, deps),
    ...createObjectVariablesExecutors(runtime, deps),
  };
}
