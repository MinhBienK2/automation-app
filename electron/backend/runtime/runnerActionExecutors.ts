...
import { createEnvironmentExecutors } from "./executors/environment.js";
import { createExtractionExecutors } from "./executors/extraction.js";
import { createFilesExecutors } from "./executors/files.js";
import { createFlowControlExecutors } from "./executors/flow-control.js";
import { createInteractionExecutors } from "./executors/interaction.js";
import { createNavigationExecutors } from "./executors/navigation.js";
import { createVariablesExecutors } from "./executors/variables/index.js";
...
export function createRunnerActionExecutors<Runtime extends RunnerActionRuntime>(
  ...
  return createActionExecutorMap({
    ...createNavigationExecutors(runtime, deps),
    ...createInteractionExecutors(runtime, deps),
    ...createExtractionExecutors(runtime, deps),
    ...createVariablesExecutors(runtime, deps),
    ...createFlowControlExecutors(runtime, deps),
    ...createEnvironmentExecutors(runtime, deps),
    ...createFilesExecutors(runtime, deps),
  });
}
