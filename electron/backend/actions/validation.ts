...
const actionValidators = createActionValidatorMap({
  ...
  desktop_click: (config) => validateDesktopStep(config),
  desktop_set_value: (config) => validateDesktopStep(config),
  desktop_type_text: (config) => validateDesktopStep(config),
  desktop_press_key: (config) => validateDesktopStep(config),
  desktop_hotkey: (config) => validateDesktopStep(config),
  desktop_read_text: (config) => validateDesktopStep(config),
  desktop_wait_for: (config) => validateDesktopStep(config),
  // No target: both act on the bound window itself.
  desktop_screenshot: () => null,
  desktop_focus_window: () => null,
  desktop_invoke_menu: (config) => validateDesktopStep(config),
});
