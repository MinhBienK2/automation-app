...
This project is indexed by GitNexus as **tik-automation** (4063 symbols, 8307 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
