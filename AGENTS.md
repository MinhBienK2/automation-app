...
This project is indexed by GitNexus as **tik-automation** (3897 symbols, 8013 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
