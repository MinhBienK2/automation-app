...
export const actionLabels: Record<ActionType, string> = {
  ...
  extract_inner_html: "Extract Inner HTML",
  extract_outer_html: "Extract Outer HTML",
  extract_computed_style: "Extract Computed Style",
  extract_all_attributes: "Extract All Attributes",
  extract_data_attributes: "Extract Data Attributes",
  extract_class_list: "Extract Class List",
  extract_descendant_attributes: "Extract Descendant Attributes",
  extract_select_value: "Extract Select Value",
  extract_select_options: "Extract Select Options",
  extract_checkbox_state: "Extract Checkbox State",
  extract_form_data: "Extract Form Data",
  extract_table_headers: "Extract Table Headers",
  extract_table_row: "Extract Table Row",
  extract_table_column: "Extract Table Column",
  extract_table_cell: "Extract Table Cell",
  extract_list_attributes: "Extract List Attributes",
  extract_structured_list: "Extract Structured List",
  extract_dimensions: "Extract Dimensions",
  extract_visibility: "Extract Visibility",
  extract_element_state: "Extract Element State",
  check_element_exists: "Extract Element Existence",
  get_page_title: "Get Page Title",
  get_meta_content: "Get Meta Content",
  extract_page_links: "Extract Page Links",
  ...
  update_number_variable: "Update Number Variable (Legacy)",
  set_number_variable: "Set Number Variable",
  generate_random_number: "Generate Random Number",
  parse_text_to_number: "Parse Text to Number",
  math_operation: "Math Operation",
  round_number: "Round Number",
  format_number: "Format Number",
  compare_numbers: "Compare Numbers",
  check_number_range: "Check Number Range",
  ...
  set_boolean_variable: "Set Boolean Variable",
  generate_random_boolean: "Generate Random Boolean",
  parse_to_boolean: "Parse to Boolean",
  boolean_logical_op: "Boolean Logical Operation",
  ...
  desktop_launch_app: "Desktop: Launch Application",
