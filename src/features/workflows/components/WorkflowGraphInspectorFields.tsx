...
export function NodeConfigFields({
  ...
  switch (node.node_type) {
    ...
    case "slice_text": {
      ...
      const start = node.config.start !== undefined ? String(node.config.start) : "0";
      const end = node.config.end !== undefined && node.config.end !== null ? String(node.config.end) : "";
    ...
    case "regex_extract": {
      ...
      const group_index = node.config.group_index !== undefined ? String(node.config.group_index) : "1";
