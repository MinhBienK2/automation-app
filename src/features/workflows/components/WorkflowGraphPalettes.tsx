...
const graphNodeDescriptions: Partial<Record<GraphNodeType, string>> = {
  ...
  evaluate_logic: "Evaluate visual rules or custom JavaScript to set a boolean condition output.",
  evaluate_expression: "Evaluate JavaScript or mathematical expressions to set a variable value.",
...
export const actionDescriptions: Record<ActionType, string> = {
  ...
  evaluate_logic: "Evaluate custom condition",
