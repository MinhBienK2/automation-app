...
import { actionPickerGroupsForSurface } from "../components/graph/ActionNodePalette";
import { actionLabels, actionOptions, allActionOptions } from "../../../lib/workflowUi";
...
import {
  ...
  logicNodeGroups,
  variableNodeGroups,
} from "../components/graph/WorkflowGraphPalettes";
