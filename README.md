...
36. Delete the workflow and confirm the dialog asks whether to keep or delete the private browser profile data. Confirm deleting profile data is selected by default, and clear it only when retained login state should stay available for manual recovery or later cleanup.
